...
| `docs/dev-log/2026-05-17-multi-agent-qa-sprint18/seed-fixtures.json` | sub-agent 가 IDOR/RAG 검증에 사용할 expected ID 매핑 |
| `docs/dev-log/2026-05-17-multi-agent-qa-sprint18/sentinel-p0-results.json` | 28 케이스 raw 결과 (재현/감사 용) |
