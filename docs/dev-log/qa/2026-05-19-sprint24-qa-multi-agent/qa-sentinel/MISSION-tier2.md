...
- **R8** F1~F4 Sprint 22 carry-over: docs/dev-log/sprints/2026-05-19-sprint22-result-report.html 의 F1~F4 정의 확인 + `git log --oneline -- frontend/src backend/src` 최근 30 commits에서 F1~F4 fix commit 검출
