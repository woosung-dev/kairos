...
- Sprint 25 Multi-Agent QA Sentinel BUG-SENTINEL-005 (`docs/dev-log/2026-05-21-sprint25-multi-agent-qa/qa-sentinel/report.md`)
- Sprint 25 plan (`docs/dev-log/2026-05-21-sprint25-multi-agent-qa/sprint-25-plan.md`) §"Wave 1 — P0"
