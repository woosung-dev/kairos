...
| ADR-019 Phase B 적용 (본 sprint 핵심) | `backend/src/common/prompts.py` 또는 `core/config.py` (모델 상수) + `docs/dev-log/adr/019-*.md` Phase B section + `backend/CONTEXT.md` B-4 invariant 확인 + 헌법 I-12 (AI 모델 고정) 검증 |
