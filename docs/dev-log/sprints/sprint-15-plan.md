...
> **FIX iter 1 patch applied (2026-05-14)**: `/docs/dev-log/sprints/2026-05-14-sprint15-plan-patch.md` 참조 — codex 적대적 검토 (Q4) 20 finding 중 15 must-fix를 patch doc에 inline. Stage 4 진입 시 본 plan + patch doc 함께 참조. **R1 진입 전 first task = T-1 fixtures + ffmpeg Dockerfile** (patch §2).
...
**Files:**
- Modify: `docs/dev-log/adr/016-personal-team-ia.md` (AD-41 본문)
- Modify: `docs/TODO.md` Sprint 17+ candidates 섹션 (S17-T-PROMOTION-REFRAME 추가)

- [ ] **Step 1: ADR-016 AD-41 inline reframe**

`docs/dev-log/adr/016-personal-team-ia.md`의 AD-41 본문 끝에 추가:
...
```bash
git add docs/dev-log/adr/016-personal-team-ia.md docs/TODO.md
...
**Files:**
- Create: `docs/dev-log/sprints/sprint-15-r8-outreach.md` (Day 0~14 log)

- [ ] **Step 1: Create outreach log skeleton**

`docs/dev-log/sprints/sprint-15-r8-outreach.md` 신규 — Day 0 outreach 채널/메시지/응답 추적:
...
```bash
git add docs/dev-log/sprints/sprint-15-r8-outreach.md
