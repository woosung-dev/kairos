...
> 다음 다음 세션 첫 read = 본 doc → `docs/dev-log/sprints/sprint-19-plan.md` §9 (v3 lock-in) → `backend/tests/integration/test_workspace_idor_matrix.py` (잔여 5 도메인 placeholder skip).
