...
| Stage | 산출물 | 상태 |
|---|---|---|
| 0 grill | `docs/dev-log/sprints/2026-05-15-sprint16-pgvector-grill.md` + CONTEXT-MAP I-20/I-21 + embeddings/CONTEXT.md(신설) + rag/CONTEXT.md R-13 | ✅ |
...
1. **본 doc** (`docs/dev-log/sprints/2026-05-15-sprint16-stage5-handoff.md`)
2. `~/.claude/plans/karrot-eager-marshmallow.md` (plan)
3. `docs/dev-log/adr/020-pgvector-hnsw-halfvec.md` (ADR-020)
4. `docs/dev-log/sprints/2026-05-15-sprint16-pgvector-plan.md` (Stage 3 plan)
...
`docs/dev-log/sprints/sprint-16-pgvector-verification.md`:
...
측정 모두 합격 시 `docs/dev-log/adr/020-pgvector-hnsw-halfvec.md` 헤더 `> **상태:** Proposed` → `Accepted` patch.
