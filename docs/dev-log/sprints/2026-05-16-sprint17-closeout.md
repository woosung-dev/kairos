...
- `docs/dev-log/sprints/2026-05-15-sprint17-qa-verification.md` — Phase A 검증 doc
- `docs/dev-log/sprints/2026-05-16-sprint17-qa-fix-loop.md` — Phase B 중간 진행
- `docs/dev-log/sprints/2026-05-16-sprint17-final-summary.md` — qa-fix 통합 직전 summary
- `docs/dev-log/sprints/2026-05-16-sprint17-closeout.md` — 본 문서 (최종 종결)
