...
8. `/Users/woosung/project/agy-project/kairos/docs/dev-log/2026-05-19-sprint24-qa-multi-agent/README.md` — QA report 인덱스
9. `/Users/woosung/project/agy-project/kairos/docs/dev-log/2026-05-19-sprint24-qa-multi-agent/sprint-24-plan.md` — **Wave 2 plan v2 (Phase 0 closure + 16 tasks 잔여)**
10. `/Users/woosung/project/agy-project/kairos/docs/dev-log/2026-05-19-sprint24-qa-multi-agent/evidence-matrix.md` — 17 tasks T-N 매트릭스
11. `/Users/woosung/project/agy-project/kairos/docs/dev-log/2026-05-19-sprint24-qa-multi-agent/post-swap-delta-stub.md` — T-2 측정 5 시나리오 정의
...
- T-AI-DATE → `docs/dev-log/2026-05-19-sprint24-qa-multi-agent/curious/report.md` + `casual/report.md` (BUG-CURIOUS-001 hallucinate 진단)
...
| BE perf spike (T-BE-PERF) | profiling 결과 doc `docs/dev-log/2026-05-NN-be-perf-spike.md` + 변경 시 도메인별 CONTEXT.md |
...
- 외부 user 1명 실 dogfooding (Sprint 22 `docs/dev-log/2026-05-19-sprint22-dogfooding.md` 12분 walkthrough)
