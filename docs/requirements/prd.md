...
**측정 fixture**: `apps/api/tests/embeddings/fixtures/recall_corpus.json` (1000 chunk + 50 query, Sprint 16 Stage 3 신설).
**측정 도구**: `apps/api/scripts/bench_vector_search.py` (Sprint 16 Stage 4 신설).
