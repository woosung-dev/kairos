...
> **권한 분기 위치**: `apps/api/src/projects/repository.py:_apply_visibility_filter` (BE-T8). admin/owner는 모든 visibility 우회. RAG 검색에서도 동일 분기 적용 — Private 프로젝트는 비멤버 응답에서 자동 제외 (ADR-014 옵션 A, RagPipelineService).
>
