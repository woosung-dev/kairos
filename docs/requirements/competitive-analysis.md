...
> **출처:** `docs/dev-log/010-future-fit-thesis.md` (ADR-010 §"비용/리스크" 인용 — "Mem/Reflect/Tana 등 소형 경쟁자는 competitive-analysis.md에서 별도 다룸")
> **상위:** `docs/dev-log/009-stage1-retrofit.md` (ADR-009 §2 Q2 status quo 보강)
...
| B3 | ADR-009 F6 wedge 선정 ADR 입력 — 본 §4.3 wedge별 차별 anchor 사용 | Sprint 6 완료 + F4 외부 인터뷰 결과 후 | `docs/dev-log/012-wedge-selection.md` (예정) |
