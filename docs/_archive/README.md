# Archive — superseded/stale 문서 보관소

> 본 폴더의 문서는 더 이상 active 가 아니다. 검색/색인에서 제외한다.
> 보관 목적: git mv 로 history 유지하면서 active 색인(`docs/README.md`)에서 분리.
...
- archive 문서는 본문 수정 금지 (history 보존). 필요 시 active 위치로 복원.
- 새 항목 archive 시 본 README 표에 사유 + 일자 추가.
