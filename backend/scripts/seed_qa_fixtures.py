...
사용:
    ...
    # 2. docs/dev-log/2026-05-17-multi-agent-qa-sprint18/seed-credentials.env 채움
    # 3. backend 디렉터리에서:
    cd backend
    uv run python scripts/seed_qa_fixtures.py \
        --env ../docs/dev-log/2026-05-17-multi-agent-qa-sprint18/seed-credentials.env \
        --out ../docs/dev-log/2026-05-17-multi-agent-qa-sprint18/seed-fixtures.json
