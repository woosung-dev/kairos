...
> 상위: `/backend/CONTEXT.md` → `/CONTEXT-MAP.md`. 상세 설계: `docs/architecture/rag-pipeline.md` (Layer 1/3).
...
6. `docs/dev-log/020-pgvector-hnsw-halfvec.md` (Sprint 16 ADR-020 — 본 도메인 인덱스/타입 전략)
